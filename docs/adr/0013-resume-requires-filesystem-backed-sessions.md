...
- Upstream ADR-0016 (the upstream design this mirrors) — https://github.com/upstream/upstream/blob/main/docs/adr/0016-resume-requires-filesystem-backed-sessions.md
